...
namespace CM3D2.SceneCapture.Plugin
{
    public class GBufferUtils : MonoBehaviour
    {
        ...
        public bool m_enable_inv_matrices = true;
        ...
        RenderTexture CreateGBufferRT(RenderTextureFormat format, int depth)
        {
        ...
        void UpdatePrevGBuffer()
        {
            ...
            {
                m_rt_gbuffer[0] = CreateGBufferRT(RenderTextureFormat.ARGB32, 0);
                m_rt_gbuffer[1] = CreateGBufferRT(RenderTextureFormat.ARGB32, 0);
                m_rt_gbuffer[2] = CreateGBufferRT(m_enable_uav ? RenderTextureFormat.ARGBHalf : RenderTextureFormat.ARGB2101010, 0);
                m_rt_gbuffer[3] = CreateGBufferRT(m_camera.hdr ? RenderTextureFormat.ARGBHalf : RenderTextureFormat.ARGB32, 0);
        ...
        public void UpdateVelocityBuffer()
        {
            ...
            {
                m_rt_velocity = CreateGBufferRT(RenderTextureFormat.ARGBHalf, 0);
                m_rt_continuity = CreateGBufferRT(RenderTextureFormat.ARGB32, 0);
        ...
        void Reset()
        {
            m_sh_gbuffer_copy = Util.GetExtraShader("GBufferCopy.shader");
            m_sh_depth_to_velocity = Util.GetExtraShader("DepthToVelocity.shader");
