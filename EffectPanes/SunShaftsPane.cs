...
namespace CM3D2.SceneCapture.Plugin
{
    ...
    {
        public SunShaftsPane( int fontSize ) : base( fontSize, "SunShafts" ) {}
        ...
        override public void SetupPane()
        {
            ...
            this.screenBlendModeBox.Text = "Screen Blend";
            ...
            this.useDepthTextureCheckbox.Text = "Use Depth Texture";
            this.ChildControls.Add( this.useDepthTextureCheckbox );

            this.dragSourceButton = new CustomButton();
            this.dragSourceButton.Text = "Drag Source";
            ...
            this.maxRadiusSlider.Text = "Max Radius";
            ...
            this.sunShaftBlurRadiusSlider.Text = "Blur Radius";
            ...
            this.radialBlurIterationsSlider.Text = "Radial Blur Iterations";
            ...
            this.sunShaftIntensitySlider.Text = "Intensity";
            ...
            this.useSkyBoxAlphaSlider.Text = "Use Skybox Alpha";
